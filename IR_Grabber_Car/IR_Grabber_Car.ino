// This project aims to educate the user on how two servos can pick up and move a foam ball
// Include Libraries
...
void setup() 
{
  ...
  // Initialize motor driver (both sides inverted to match original wiring sense)
  initMotors(true, true);
  ...
  // Set motor enable at full speed
  forward();
  servo1.write(angle);
  servo2.write(angle1);  
