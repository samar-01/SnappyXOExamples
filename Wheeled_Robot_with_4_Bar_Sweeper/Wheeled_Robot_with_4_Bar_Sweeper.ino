// This project aims to educate the user on how to control a differential drive robot with two DC motors and induce a sweeping motion with a 4 bar mechanism and finite servo.
#include <Servo.h>
#include <MicroBlue.h>
