// This code controls a car with a steering mechanism via IR Remote. You can control the speed and steer angle of the car.
// Include libraries
#include <Servo.h>
#include <IRremote.h>
...
//        }
            ...
            motorSpeed = 0.5;
            if (motorDir == 1)       forward((int)(255 * motorSpeed));
            else if (motorDir == -1) reverse((int)(255 * motorSpeed));
        }
