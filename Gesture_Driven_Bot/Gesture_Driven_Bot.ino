// This project aims to educate the user on how an ultrasonic sensor can detect different heights to drive a robot foward and backward
...
// invertR=true matches original forward direction (InputOne HIGH, InputTwo LOW)
