// This project aims to educate the user on how to control a differential drive robot with two motors and LEDs using a bluetooth module and the MicroBlue app.
#include <MicroBlue.h>
