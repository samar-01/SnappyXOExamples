// This project aims to educate the user on how connect an Ultrasonic sensor and demonstrate how this sensor can help a 2WD car avoid obstacles.
...
void setup() {
  ...
  // Initialize motors (no invert flags needed — hardware rewired to match library pins)
...
void loop() {
  ...
  // randomly choose whether to turn left or right if an obstacle is encountered; in this case, 0 is turning right and 1 is turning left
  randint = random(0,2);
