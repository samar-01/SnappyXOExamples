// This project aims to educate the user on how to control a 2WD car using IR as well as operating a passive ball dropping mechanism.
// Include libraries
#include <IRremote.h>
...
void loop() {
  ...
  if (IrReceiver.decode()) {
    ...
    // check for which button was pressed on IR Remote and execute relevant functions
